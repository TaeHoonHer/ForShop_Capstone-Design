...
class HashtagServiceTest {
    ...
    void givenHashtagNames_whenFindingHashtags_thenReturnsHashtagSet() {
        ...
        given(hashtagRepository.findHashtagsByHashtagNameIn(hashtagNames)).willReturn(List.of(
                Hashtag.of("java"),
                Hashtag.of("spring"),
                Hashtag.of("boots")
        ));
        ...
        then(hashtagRepository).should().findHashtagsByHashtagNameIn(hashtagNames);
    }
}